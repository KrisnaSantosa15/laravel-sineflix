...
@section('content')
<div class="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
        <a href="{{ url('/') }}"
            class="flex items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white">
            <img src="{{ url('images/SineFlix-logo.png') }}" class="mr-4 h-11" alt="Sineflix Logo">
            <span>SineFlix</span>
        </a>
        <!-- Card -->
            ...
            <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                            <button type="button"
                                onclick="togglePasswordVisibility('password_confirmation','show-icon-confirmation','hide-icon-confirmation')"
                                class="text-gray-400 focus:outline-none dark:text-gray-600">
                                <svg id="show-icon-confirmation" class="w-6 h-6 text-gray-800 dark:text-white"
                                ...
                                <svg id="hide-icon-confirmation" class="w-6 h-6 text-gray-800 dark:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
